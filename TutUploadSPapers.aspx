<%@ Page Title="" Language="C#" MasterPageFile="~/Tutor.master" AutoEventWireup="true" CodeFile="TutUploadSPapers.aspx.cs" Inherits="TutUploadSPapers" %>
...
<br />
        ...
        <tr>
            <td align="center">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large"
                    ForeColor="#000066" Text="Upload Sample Papers"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
    ...
    <asp:Button ID="btnUpload" runat="server" Font-Bold="True" Font-Names="Arial" 
        Font-Size="Large" Height="30px" Text="Upload" Width="120px" onclick="btnUpload_Click"/>
            </td>
            <td>
            <asp:Button ID="btnView" runat="server" Font-Bold="True" Font-Names="Arial" 
        Font-Size="Large" Height="30px" Text="View Sample Papers" Width="195px" 
    ...
    <table class="style12" style="height: 116px">
        <tr>
            <td align="center">
    <asp:GridView ID="GridView1" runat="server" Caption="Sample Papers" CaptionAlign="Top" AutoGenerateColumns="false" 
            DataKeyNames="Id"
