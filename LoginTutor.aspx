<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginTutor.aspx.cs" Inherits="LoginTutor" %>
            ...
            <tr>
                ...
                <td style="text-decoration: underline">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Size="Large" 
                        Font-Overline="False" NavigateUrl="~/RegisterTut.aspx">New User Registration</asp:HyperLink>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
