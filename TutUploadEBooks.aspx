<%@ Page Title="" Language="C#" MasterPageFile="~/Tutor.master" AutoEventWireup="true" CodeFile="TutUploadEBooks.aspx.cs" Inherits="TutUploadEBooks" %>
...
<br />
        ...
        <tr>
            <td align="center">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" 
                    ForeColor="#000066" Text="Upload e-Books"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
    ...
    <asp:Button ID="btnUpload" runat="server" Font-Bold="True" Font-Names="Arial" 
        ...
        Font-Size="Large" Height="30px" Text="View EBooks" Width="133px" 
    ...
    <table class="style12" style="height: 116px">
        <tr>
            <td align="center">
    <asp:GridView ID="GridView1" runat="server" Caption="e-Books" CaptionAlign="Top" AutoGenerateColumns="false" 
            DataKeyNames="Id"
