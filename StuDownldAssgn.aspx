<%@ Page Title="" Language="C#" MasterPageFile="~/Student.master" AutoEventWireup="true" CodeFile="StuDownldAssgn.aspx.cs" Inherits="StuDownldAssgn" %>
        ...
        <tr>
            <td align="center">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" 
                    ForeColor="#000066" Text="Download Assignments"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
