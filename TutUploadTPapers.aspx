<%@ Page Title="" Language="C#" MasterPageFile="~/Tutor.master" AutoEventWireup="true" CodeFile="TutUploadTPapers.aspx.cs" Inherits="TutUploadTPapers" %>
...
<br />
        ...
        <tr>
            <td align="center">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" 
                    ForeColor="#000066" Text="Upload Test Papers"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
    ...
    <asp:Button ID="btnView" runat="server" Font-Bold="True" Font-Names="Arial" 
        Font-Size="Large" Height="30px" Text="View Test Papers" Width="200px" 
    ...
    <table class="style12" style="height: 116px">
        <tr>
            <td align="center">
    <asp:GridView ID="GridView1" runat="server" Caption="Test Papers" CaptionAlign="Top" AutoGenerateColumns="false" 
            DataKeyNames="Id"
