<%@ Page Title="" Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="ParentDownldSPapers.aspx.cs" Inherits="ParentDownldSPapers" %>
        ...
        <tr>
            <td align="center">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large"
                    ForeColor="#000066" Text="Download Sample Papers"></asp:Label>
            </td>
        </tr>
    </table>
    <br />
